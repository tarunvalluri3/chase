...
export const clerkAppearance = {
  ...
  variables: {
    ...
    colorBackground: 'var(--color-raised)',
    colorInputBackground: 'var(--color-overlay)',
    ...
    colorShimmer: 'var(--color-overlay)',
  ...
  elements: {
    ...
    card: 'w-full gap-6 rounded-(--radius-xl) border border-(--border-hairline) bg-raised p-6 shadow-none',
    header: 'gap-1.5',
    headerTitle: 'text-title text-ink',
    headerSubtitle: 'text-body text-ink-2',
    logoBox: 'hidden',
    socialButtonsBlockButton:
      'h-11 rounded-(--radius-md) border border-(--border-strong) bg-overlay text-ink text-body hover:bg-overlay/80 transition-colors',
    ...
    formFieldInput:
      'h-11 rounded-(--radius-md) border border-(--border-strong) bg-overlay text-ink placeholder:text-ink-3 focus:border-accent',
    ...
    identityPreview: 'rounded-(--radius-md) border border-(--border-strong) bg-overlay',
    identityPreviewText: 'text-body text-ink',
    identityPreviewEditButton: 'text-accent',
    otpCodeFieldInput: 'border-(--border-strong) bg-overlay text-ink',
    formResendCodeLink: 'text-accent',
    alternativeMethodsBlockButton: 'text-body text-ink hover:bg-overlay',
    badge: 'bg-indigo text-ink border-none',
    avatarBox: 'ring-2 ring-(--border-strong)',
    userButtonPopoverCard: 'bg-raised border border-(--border-hairline)',
