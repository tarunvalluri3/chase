...
export const NotificationBell = forwardRef(function NotificationBell(_props, ref) {
  ...
  return (
    <button
      ...
      className="relative flex h-9 w-9 items-center justify-center rounded-(--radius-sm) text-ink-2 hover:text-ink"
    >
      <Bell size={20} strokeWidth={1.75} aria-hidden="true" />
      {unreadCount > 0 && (
        <span
          aria-hidden="true"
          className="absolute top-1.5 right-1.5 h-1.5 w-1.5 rounded-(--radius-pill)"
