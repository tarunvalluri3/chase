      ...
      <AnimatePresence>
        {toast && (
          <motion.div
            ...
            className="pointer-events-auto max-w-[min(24rem,calc(100vw-2rem))] rounded-(--radius-md) bg-raised px-4 py-3 text-body text-ink"
            style={{ boxShadow: '0 6px 24px rgba(0,0,0,.45)' }}
          >
            {toast.message}
          </motion.div>
        )}
